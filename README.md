...
```javascript
import toFilled from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-to-filled@deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { assign } from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-to-filled@deno/mod.js';
```
